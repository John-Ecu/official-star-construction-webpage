        ...
        <div className="container mx-auto px-4 py-3 md:py-6 flex items-center justify-between">
          <div className="flex items-center gap-3 md:gap-6 min-w-0">
            <img 
              ...
              className="h-14 sm:h-20 md:h-24 w-auto brightness-110 contrast-110 flex-shrink-0"
            />
            <div className="flex flex-col min-w-0">
              <span className="text-white font-black text-2xl sm:text-3xl md:text-5xl tracking-tight leading-none">
                STAR
              </span>
              <span className="text-accent font-bold text-xs sm:text-sm md:text-xl tracking-widest leading-tight">
                CONSTRUCTION
              </span>
            </div>
          </div>
